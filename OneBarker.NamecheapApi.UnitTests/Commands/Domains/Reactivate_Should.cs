...
public class Reactivate_Should : CommonTestBase<Reactivate>
{
    public Reactivate_Should(ITestOutputHelper outputHelper)
        : base(outputHelper)
    {
    }

    protected override Reactivate CreateValidCommand()
    {
        return new Reactivate(GoodConfig) { DomainName = "example.com", Years = 1 };
    }
